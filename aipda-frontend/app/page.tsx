    ...
    <main style={{ minHeight: '100vh', backgroundColor: 'var(--color-canvas)' }}>
      ...
      <section style={{ position: 'relative', paddingTop: 88, paddingBottom: 72, overflow: 'hidden' }}>
        ...
        <div className="orb" style={{
          ...
          background: 'radial-gradient(circle, var(--color-orb-peach) 0%, transparent 70%)',
          bottom: 0, right: '20%', opacity: 0.35,
        }} />
        ...
        <div className="hero-grid container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div>
            ...
            <p style={{
              ...
              lineHeight: 1.65, margin: '0 0 36px', maxWidth: 400, letterSpacing: '0.16px',
            }}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              ...
              {user ? (
                <button className="btn-outline" onClick={() => router.push('/datasets')}>
                  My Datasets →
                </button>
              ) : (
          ...
          <div style={{
            ...
            <div className="orb" style={{
              ...
              background: 'radial-gradient(circle, var(--color-orb-sky) 0%, transparent 70%)',
              top: -60, right: -60, opacity: 0.35,
            }} />
            {STATS.map((s, i) => (
              <div key={s.stat} style={{
                ...
                <div>
                  ...
                  <span style={{
                    ...
                    color: 'var(--color-muted)', marginLeft: 10,
                  }}>
                    {s.label}
                  </span>
                </div>
      ...
      <section style={{ borderTop: '1px solid var(--color-hairline)', padding: '80px 0 100px' }}>
        <div className="container">
          <div style={{ marginBottom: 52 }}>
            ...
            <h2 className="display-lg" style={{ color: 'var(--color-ink)', margin: 0 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 48 }}>
            {HOW_IT_WORKS.map((step) => (
              <div key={step.num} className="step-card">
                ...
                <h3 className="display-sm" style={{ color: 'var(--color-ink)', margin: '10px 0 12px' }}>
                  {step.title}
                </h3>
                <p style={{
                  fontFamily: 'var(--font-body)', fontSize: 14,
                  color: 'var(--color-body)', lineHeight: 1.65, margin: 0,
                }}>
                  {step.desc}
                </p>
              </div>
